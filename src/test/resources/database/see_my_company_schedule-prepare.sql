...
INSERT INTO booking(person_id, service_id) VALUES((SELECT id FROM person WHERE email='user@domain.com'), (SELECT id FROM service WHERE hour_schedule_id=(SELECT id FROM hour_schedule WHERE start_time='23:00:00')));
INSERT INTO booking(person_id, service_id) VALUES((SELECT id FROM person WHERE email='user@domain.com'), (SELECT id FROM service WHERE hour_schedule_id=(SELECT id FROM hour_schedule WHERE start_time='12:00:00')));
