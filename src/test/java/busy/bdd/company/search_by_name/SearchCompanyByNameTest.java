...
/**
 * Execute the feature of searching a Company by his name, which gherkin definition is in the path
...
@CucumberOptions(features = "classpath:busy/bdd/i_can_search_company_by_name.feature",
        plugin = { "html:target/cucumber" }, glue = "classpath:busy/bdd/company/search_by_name",
