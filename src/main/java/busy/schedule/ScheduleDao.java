...
public interface ScheduleDao {
     ...
     * 
     * @param branch
     *            branch attached to the schedule
     * @param year
     *            the year requested
     * @return The resultant year schedule
     */
    YearSchedule findByBranchAndYear(Branch branch, int year);
     ...
     */
    List<WeekSchedule> findByYearAndWeeks(int year, int... weeks);

    /**
     * Gets the week schedule selected as the default one.
     * 
     * @return The default week schedule
     */
    WeekSchedule findDefaultWeek();
