...
@SessionAttributes(value = { BusyController.NOTIFICATIONS_SESSION, BusyController.ROLES_SESSION,
    BusyController.USER_SESSION, BusyController.USERNAME_SESSION, BusyController.ROLE_SESSION, BusyController.SERVICE_TYPES_SESSION })
public abstract class BusyController {
    ...
    protected static final String SERVICE_FORM_SESSION = "serviceForm";
