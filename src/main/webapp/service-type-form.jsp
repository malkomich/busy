    ...
    <form:form class="service-type-form" id="serviceTypeForm" action="javascript:saveServiceType()"
        ...
        <div class="row">
            <div class="col-sm-6 form-group">
                ...
                <form:input path="maxBookingsPerRole" id="maxBookingsPerRole" tabindex="3" type="number" min="1"
                    step="1" class="form-control" placeholder="${bookingsPlaceHolder}" />
            </div>
            <div class="col-sm-6 form-group">
                <spring:message code="duration.placeholder" var="durationPlaceHolder" />
                <label for="duration">${durationPlaceHolder}:</label>
                <form:input path="duration" id="duration" tabindex="4" type="number" min="5" step="1"
                    class="form-control" placeholder="${durationPlaceHolder}" />
            </div>
        </div>
